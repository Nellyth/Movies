movie_genre=(
    ...
    ('Martial arts cinema','Martial arts cinema'),
    ('Author cinema','Author cinema'),
    ...
    ('Film peplum','Film peplum'),
    ('Police cinema','Police cinema'),
    ('Political cinema','Political cinema'),
    ('Pornographic movies','Pornographic movies'),
    ('Propaganda cinema','Propaganda cinema'),
    ('Romantic cinema','Romantic cinema'),
    ('Cinema S','Cinema S'),
    ('Surreal cinema','Surreal cinema'),
    ...
    ('Dramedia','Dramedia'),
    ('Melodrama','Melodrama'),
    ('Snuff movies','Snuff movies'),
    ('Road movie','Road movie'),
    ('Spoof movie','Spoof movie'),
    ('Thriller','Thriller'),
    ('Western','Western'),
)
